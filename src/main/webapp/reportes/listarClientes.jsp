...
<body>
	...
	<div id="cuadro">
		...
		ArrayList<ClientesVO> lista = controller.getListarClientes();
		if(lista.size()>0){
		%>
	<strong><center><h3><b>Listado de Clientes</b></h3><center></strong>
		<table class="table table-striped">
			...
			<tr>
				...
				<td><center><%=dto.getDireccion()%></center></td>
				<td><center><%=dto.getTelefono()%></center></td>
				<td><center><%=dto.getCorreo()%></center></td>
			</tr>
		<%}}else{
		...
		<center><h1>¡La lista de clientes está vacia!</h1></center>
			<%} %>
	</div>
