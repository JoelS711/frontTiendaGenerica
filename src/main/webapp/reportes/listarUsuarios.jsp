...
<body>
	...
	<div id="cuadro">
		<strong><center><h3><b>Listado de Usuarios</b></h3><center></strong>
		<%
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<td><center><%=dto.getUsuario()%></center></td>
				<td><center><%=dto.getContrasena()%></center></td>
			</tr>
		<%}}else{
			%>	
		</table>
		
			<center><h1>¡La lista de Usuarios está vacia!</h1></center>
			<%} %>
	</div>
