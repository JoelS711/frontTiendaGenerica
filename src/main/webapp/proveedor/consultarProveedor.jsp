	...
	<header class="header">
		...
		<div class="container col-lg-2">
			<div class="form-group text-center">
				<form action="/proveedor/consultarProveedor" method="POST">
					<div class="form-group text-center">
						<p style="color: white">
							<strong>CONSULTAR PROVEEDOR</strong>
						</p>
						<img src="./img/usuario2.png" height="80" width="80" />
					</div>
					<div class="form-group">
						<input class="form-control" type="text" name="nit" id="nit"
							value="${proveedor.nit}" placeholder="Ingrese NIT"
